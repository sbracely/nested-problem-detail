 ...
 * <p>
 * This configuration class is used to automatically configure {@link Boot3MvcExtendedProblemDetailExceptionHandler}
 ...
 *     <li>No custom {@link Boot3MvcExtendedProblemDetailExceptionHandler} bean exists in the container</li>
 * </ul>
 * <p>
 * Usage example:
 * </p>
 ...
 * }</pre>
 *
 * @see Boot3MvcExtendedProblemDetailExceptionHandler
 * @since 1.0.0
 */
@AutoConfiguration
@ConditionalOnWebApplication(type = ConditionalOnWebApplication.Type.SERVLET)
@EnableConfigurationProperties(Boot3MvcExtendedProblemDetailProperties.class)
@ConditionalOnProperty(prefix = "extended.problem-detail", name = "enabled", havingValue = "true", matchIfMissing = true)
public class Boot3MvcExtendedProblemDetailAutoConfiguration {

    /**
     * Creates a new instance of {@link Boot3MvcExtendedProblemDetailAutoConfiguration}.
     */
    public Boot3MvcExtendedProblemDetailAutoConfiguration() {
    }
    ...
    public Boot3CommonExtendedProblemDetailLog extendedProblemDetailLog(Boot3MvcExtendedProblemDetailProperties properties) {
        return new Boot3CommonExtendedProblemDetailLog(properties.getLogging().getAtLevel(), properties.getLogging().isPrintStackTrace());
    }

    /**
     * Creates and registers the {@link Boot3MvcExtendedProblemDetailExceptionHandler} bean.
     *
    ...
    @Bean
    @ConditionalOnMissingBean
    public Boot3MvcExtendedProblemDetailExceptionHandler requestExceptionHandler(Boot3CommonExtendedProblemDetailLog extendedProblemDetailLog) {
        return new Boot3MvcExtendedProblemDetailExceptionHandler(extendedProblemDetailLog);
    }
