...
/**
 * Tests for {@link Boot3MvcExtendedProblemDetailProperties}.
 *
 * @since 1.0.0
 */
class Boot3MvcExtendedProblemDetailPropertiesTests {

    private final ApplicationContextRunner contextRunner = new ApplicationContextRunner()
            .withUserConfiguration(Boot3MvcExtendedProblemDetailPropertiesConfiguration.class);
    ...
    static class Boot3MvcExtendedProblemDetailPropertiesConfiguration {
    }
}
