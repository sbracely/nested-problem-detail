...
/**
 * Tests for {@link Boot3MvcExtendedProblemDetailExceptionHandler}.
 *
 * @since 1.0.0
 */
class Boot3MvcExtendedProblemDetailExceptionHandlerTests {

    private Boot3MvcRecordingLog mockLogger;

    private Boot3MvcExtendedProblemDetailExceptionHandler handler;
    private WebRequest webRequest;

    @BeforeEach
    void setUp() {
        mockLogger = new Boot3MvcRecordingLog();
        Boot3CommonExtendedProblemDetailLog log = new Boot3CommonExtendedProblemDetailLog(LogLevel.DEBUG, false);
        handler = new Boot3MvcExtendedProblemDetailExceptionHandler(log);
    ...
    @Nested
    class Boot3MvcHandleMethodArgumentNotValid {

        @Test
        void shouldReturnExtendedProblemDetailWithFieldErrors() {
            BindingResult bindingResult = new BeanPropertyBindingResult(new Boot3MvcTestBean(), "testBean");
        ...
        void shouldLogHandleMethodArgumentNotValid() {
            Boot3MvcExtendedProblemDetailExceptionHandlerWithMockLogger h = handlerWithMockLogger(LogLevel.DEBUG, false);
            BindingResult bindingResult = new BeanPropertyBindingResult(new Boot3MvcTestBean(), "testBean");
    ...
    @Nested
    class Boot3MvcHandleHandlerMethodValidationException {
    ...
    @Nested
    class Boot3MvcHandleMethodValidationException {
    ...
    @Nested
    class Boot3MvcHandleErrorResponseException {
    ...
    @Nested
    class Boot3MvcHandleAsyncRequestNotUsableException {
    ...
    @Nested
    class Boot3MvcResolveMethodArgumentNotValidException {
    ...
    @Nested
    class Boot3MvcResolveWebExchangeBindException {
    ...
    @Nested
    class Boot3MvcResolveBindingResult {
    ...
    @Nested
    class Boot3MvcObjectErrorToError {
    ...
    @Nested
    class Boot3MvcAddParameterErrors {
    ...
    @Nested
    class Boot3MvcResolveMethodValidationException {
    ...
    @Nested
    class Boot3MvcResolveHandlerMethodValidationExceptionVisitors {
    ...
    @Nested
    class Boot3MvcDelegateToSuperHandlers {
    ...
    @Nested
    class Boot3MvcLogBehavior {

        @Test
        void shouldLogWithExceptionWhenPrintStackTraceEnabled() {
            Boot3MvcExtendedProblemDetailExceptionHandlerWithMockLogger h = handlerWithMockLogger(LogLevel.DEBUG, true);
            BindingResult bindingResult = new BeanPropertyBindingResult(new Boot3MvcTestBean(), "testBean");
            bindingResult.addError(new FieldError("testBean", "f", "error"));
            MethodArgumentNotValidException ex = new MethodArgumentNotValidException(createMethodParameter(), bindingResult);
        ...
        void shouldNotLogWhenLevelIsOff() {
            Boot3MvcExtendedProblemDetailExceptionHandlerWithMockLogger h = handlerWithMockLogger(LogLevel.OFF, false);
            BindingResult bindingResult = new BeanPropertyBindingResult(new Boot3MvcTestBean(), "testBean");
            bindingResult.addError(new FieldError("testBean", "f", "error"));
            MethodArgumentNotValidException ex = new MethodArgumentNotValidException(createMethodParameter(), bindingResult);
        ...
        void shouldLogAtInfoLevel() {
            Boot3MvcExtendedProblemDetailExceptionHandlerWithMockLogger h = handlerWithMockLogger(LogLevel.INFO, false);
            BindingResult bindingResult = new BeanPropertyBindingResult(new Boot3MvcTestBean(), "testBean");
            bindingResult.addError(new FieldError("testBean", "f", "error"));
            MethodArgumentNotValidException ex = new MethodArgumentNotValidException(createMethodParameter(), bindingResult);
        ...
        void shouldLogAtWarnLevel() {
            Boot3MvcExtendedProblemDetailExceptionHandlerWithMockLogger h = handlerWithMockLogger(LogLevel.WARN, false);
            BindingResult bindingResult = new BeanPropertyBindingResult(new Boot3MvcTestBean(), "testBean");
            bindingResult.addError(new FieldError("testBean", "f", "error"));
            MethodArgumentNotValidException ex = new MethodArgumentNotValidException(createMethodParameter(), bindingResult);
        ...
        void shouldLogAtErrorLevel() {
            Boot3MvcExtendedProblemDetailExceptionHandlerWithMockLogger h = handlerWithMockLogger(LogLevel.ERROR, false);
            BindingResult bindingResult = new BeanPropertyBindingResult(new Boot3MvcTestBean(), "testBean");
            bindingResult.addError(new FieldError("testBean", "f", "error"));
            MethodArgumentNotValidException ex = new MethodArgumentNotValidException(createMethodParameter(), bindingResult);
    ...
    private Boot3MvcExtendedProblemDetailExceptionHandlerWithMockLogger handlerWithMockLogger(
            LogLevel level, boolean printStackTrace) {
        return new Boot3MvcExtendedProblemDetailExceptionHandlerWithMockLogger(
                new Boot3CommonExtendedProblemDetailLog(level, printStackTrace), mockLogger);
    }

    private MethodParameter createMethodParameter() {
        try {
            Method method = getClass().getMethod("testMethod", Boot3MvcTestBean.class);
    ...
    public void testMethod(Boot3MvcTestBean bean) {
    ...
    private ParameterErrors buildParameterErrors(List<ObjectError> objectErrors) {
        BeanPropertyBindingResult bindingResult = new BeanPropertyBindingResult(new Boot3MvcTestBean(), "testBean");
    ...
    private HandlerMethodValidationException buildExceptionVisiting(
        ...
        MethodValidationResult mvr = MethodValidationResult.create(
                new Boot3MvcTestBean(), getTestMethod(), List.of(placeholder));
    ...
    private static Boot3MvcLogVerifier verify(Boot3MvcRecordingLog log) {
        return new Boot3MvcLogVerifier(log);
    }

    private static Boot3MvcMessageExpectation eq(String expected) {
        return actual -> actual.equals(expected);
    }

    private static Boot3MvcThrowableExpectation eq(Throwable expected) {
        return actual -> actual == expected;
    }

    private static Boot3MvcMessageExpectation matches(String regex) {
        return actual -> actual.matches(regex);
    }

    private static Boot3MvcThrowableExpectation isNull() {
        return actual -> actual == null;
    }

    private static void verifyNoInteractions(Boot3MvcRecordingLog log) {
        assertThat(log.events()).isEmpty();
    }

    private Method getTestMethod() {
        try {
            return getClass().getMethod("testMethod", Boot3MvcTestBean.class);
        } catch (NoSuchMethodException e) {
            throw new RuntimeException(e);
        }
    }
    ...
    static class Boot3MvcExtendedProblemDetailExceptionHandlerWithMockLogger
            extends Boot3MvcExtendedProblemDetailExceptionHandler {

        Boot3MvcExtendedProblemDetailExceptionHandlerWithMockLogger(
        ...
        private void injectLogger(Log mockLog) {
            try {
                java.lang.reflect.Field f =
                        Boot3MvcExtendedProblemDetailExceptionHandler.class.getDeclaredField("logger");
    ...
    @FunctionalInterface
    interface Boot3MvcMessageExpectation {
        boolean matches(String actual);
    }

    @FunctionalInterface
    interface Boot3MvcThrowableExpectation {
        boolean matches(Throwable actual);
    }

    record Boot3MvcLogEvent(String level, String message, Throwable throwable) {
    }

    static final class Boot3MvcLogVerifier {

        private final Boot3MvcRecordingLog log;

        Boot3MvcLogVerifier(Boot3MvcRecordingLog log) {
            this.log = log;
        }
        ...
        void debug(Boot3MvcMessageExpectation message, Boot3MvcThrowableExpectation throwable) {
        ...
        void info(Boot3MvcMessageExpectation message, Boot3MvcThrowableExpectation throwable) {
        ...
        void warn(Boot3MvcMessageExpectation message, Boot3MvcThrowableExpectation throwable) {
        ...
        void error(Boot3MvcMessageExpectation message, Boot3MvcThrowableExpectation throwable) {
            assertLogged("error", message::matches, throwable::matches);
        }

        private void assertLogged(String level, Boot3MvcMessageExpectation message, Boot3MvcThrowableExpectation throwable) {
    ...
    static final class Boot3MvcRecordingLog implements Log {

        private final List<Boot3MvcLogEvent> events = new ArrayList<>();

        List<Boot3MvcLogEvent> events() {
            return events;
        }

        private void add(String level, Object message, Throwable throwable) {
            events.add(new Boot3MvcLogEvent(level, String.valueOf(message), throwable));
        }
    ...
    public static class Boot3MvcTestBean {
