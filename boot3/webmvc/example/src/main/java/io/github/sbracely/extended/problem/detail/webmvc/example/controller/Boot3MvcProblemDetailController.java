...
import io.github.sbracely.extended.problem.detail.webmvc.example.valid.annotation.Boot3MvcCheckMultipartFile;
...
public class Boot3MvcProblemDetailController {

    private static final Logger logger = LoggerFactory.getLogger(Boot3MvcProblemDetailController.class);

    private final RequestMappingHandlerMapping requestMappingHandlerMapping;

    private final Boot3MvcProblemDetailService problemDetailService;

    public Boot3MvcProblemDetailController(RequestMappingHandlerMapping requestMappingHandlerMapping, Boot3MvcProblemDetailService problemDetailService) {
    ...
    public void httpMediaTypeNotSupportedException(Boot3MvcProblemDetailRequest problemDetailRequest) {
    ...
    public void httpMediaTypeNotAcceptableException(Boot3MvcProblemDetailRequest problemDetailRequest) {
    ...
    public void methodArgumentNotValidException(@RequestBody @Validated Boot3MvcProblemDetailRequest problemDetailRequest) {
    ...
    public void handlerMethodValidationExceptionModelAttribute(@Boot3MvcCheckPassword(message = "Password cannot be empty") Boot3MvcProblemDetailRequest problemDetailRequest) {
    ...
    public void handlerMethodValidationExceptionRequestBody(@RequestBody @Boot3MvcCheckPassword(message = "Password cannot be empty") Boot3MvcProblemDetailRequest problemDetailRequest) {
    ...
    public void handlerMethodValidationExceptionRequestPart(@RequestPart(required = false) @Boot3MvcCheckMultipartFile(extensionIncludeMessage = "File type not supported",
    ...
    public void extendedErrorResponseException() {
        ...
        throw new Boot3MvcExtendedErrorResponseException(HttpStatus.INTERNAL_SERVER_ERROR, extendedProblemDetail);
    }
    ...
    public void webExchangeBindException(HttpServletRequest httpServletRequest,
                                         @RequestBody @Validated Boot3MvcProblemDetailRequest problemDetailRequest,
    ...
    public void conversionNotSupportedException(HttpServletRequest httpServletRequest, String data) throws Exception {
        ...
        Boot3MvcProblemDetailRequest problemDetailRequest = simpleTypeConverter.convertIfNecessary(data, Boot3MvcProblemDetailRequest.class, methodParameters[0]);
    ...
    public void methodArgumentConversionNotSupportedException(@RequestParam Boot3MvcProblemDetailRequest error) {
    ...
    public void httpMessageNotReadableException(@RequestBody Boot3MvcProblemDetailRequest data) {
    ...
    public Boot3MvcProblemDetailResponse httpMessageNotWritableException() {
        logger.info("httpMessageNotWritableException");
        return new Boot3MvcProblemDetailResponse();
    }
    ...
    public void methodValidationException() {
        ...
        Boot3MvcProblemDetailRequest problemDetailRequest = new Boot3MvcProblemDetailRequest();
