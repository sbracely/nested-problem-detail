...
public class Boot3MvcCheckMultipartFileValidator implements ConstraintValidator<Boot3MvcCheckMultipartFile, MultipartFile> {
    ...
    @Override
    public void initialize(Boot3MvcCheckMultipartFile constraintAnnotation) {
