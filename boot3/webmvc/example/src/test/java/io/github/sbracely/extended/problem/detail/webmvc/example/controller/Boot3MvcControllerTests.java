...
import io.github.sbracely.extended.problem.detail.webmvc.example.config.Boot3MvcMethodValidationConfiguration;
import io.github.sbracely.extended.problem.detail.webmvc.example.exception.Boot3MvcExtendedErrorResponseException;
...
import io.github.sbracely.extended.problem.detail.webmvc.example.service.Boot3MvcProblemDetailService;
...
class Boot3MvcControllerTests {

    private static final Logger logger = LoggerFactory.getLogger(Boot3MvcControllerTests.class);
     ...
     * @see Boot3MvcProblemDetailController#httpRequestMethodNotSupportedException()
     */
    @Test
     ...
     * @see Boot3MvcProblemDetailController#httpMediaTypeNotSupportedException(Boot3MvcProblemDetailRequest)
     */
    @Test
     ...
     * @see Boot3MvcProblemDetailController#httpMediaTypeNotAcceptableException(Boot3MvcProblemDetailRequest)
     */
    @Test
     ...
     * @see Boot3MvcProblemDetailController#missingPathVariableException(Integer)
     */
    @Test
     ...
     * @see Boot3MvcProblemDetailController#missingServletRequestParameterException(Integer)
     */
    @Test
     ...
     * @see Boot3MvcProblemDetailController#missingServletRequestPartException(MultipartFile)
     */
    @Test
     ...
     * @see Boot3MvcProblemDetailController#servletRequestBindingException()
     */
    @Test
     ...
     * @see Boot3MvcProblemDetailController#unsatisfiedServletRequestParameterException()
     */
    @Test
     ...
     * @see Boot3MvcProblemDetailController#orgSpringWebBindMissingRequestValueException()
     */
    @Test
     ...
     * @see Boot3MvcProblemDetailController#missingMatrixVariableException(String, List)
     */
    @Test
     ...
     * @see Boot3MvcProblemDetailController#missingRequestCookieException(String)
     */
    @Test
     ...
     * @see Boot3MvcProblemDetailController#missingRequestHeaderException(String)
     */
    @Test
     ...
     * @see Boot3MvcProblemDetailController#methodArgumentNotValidException(Boot3MvcProblemDetailRequest)
     */
    @Test
     ...
     * @see Boot3MvcProblemDetailController#handlerMethodValidationExceptionCookieValue(String)
    ...
    /**
     * @see HandlerMethodValidationException
     * @see Boot3MvcProblemDetailController#handlerMethodValidationExceptionMatrixVariable(String, List)
    ...
    /**
     * @see HandlerMethodValidationException
     * @see Boot3MvcProblemDetailController#handlerMethodValidationExceptionModelAttribute(Boot3MvcProblemDetailRequest)
    ...
    /**
     * @see HandlerMethodValidationException
     * @see Boot3MvcProblemDetailController#handlerMethodValidationExceptionPathVariable(String)
    ...
    /**
     * @see HandlerMethodValidationException
     * @see Boot3MvcProblemDetailController#handlerMethodValidationExceptionRequestBody(Boot3MvcProblemDetailRequest)
    ...
    /**
     * @see HandlerMethodValidationException
     * @see Boot3MvcProblemDetailController#handlerMethodValidationExceptionRequestBodyValidationResult(List)
    ...
    /**
     * @see HandlerMethodValidationException
     * @see Boot3MvcProblemDetailController#handlerMethodValidationExceptionRequestHeader(String)
    ...
    /**
     * @see HandlerMethodValidationException
     * @see Boot3MvcProblemDetailController#handlerMethodValidationExceptionRequestParam(String, String)
    ...
    /**
     * @see HandlerMethodValidationException
     * @see Boot3MvcProblemDetailController#handlerMethodValidationExceptionRequestPart(MultipartFile)
    ...
    /**
     * @see HandlerMethodValidationException
     * @see Boot3MvcProblemDetailController#handlerMethodValidationExceptionOther(String, String, String)
     ...
     * @see Boot3MvcProblemDetailController#asyncRequestTimeoutException()
     */
    @Test
     ...
     * @see Boot3MvcProblemDetailController#errorResponseException()
     */
    @Test
    ...
    /**
     * @see Boot3MvcExtendedErrorResponseException
     * @see Boot3MvcProblemDetailController#extendedErrorResponseException()
     */
    @Test
     ...
     * @see Boot3MvcProblemDetailController#responseStatusException()
     */
    @Test
     ...
     * @see Boot3MvcProblemDetailController#serverWebInputException()
     */
    @Test
     ...
     * @see Boot3MvcProblemDetailController#unsatisfiedRequestParameterException()
     */
    @Test
     ...
     * @see Boot3MvcProblemDetailController#orgSpringframeworkWebServerMissingRequestValueException(HttpServletRequest, String)
     */
    @Test
     ...
     * @see Boot3MvcProblemDetailController#webExchangeBindException(HttpServletRequest, Boot3MvcProblemDetailRequest, BindingResult)
     */
    @Test
     ...
     * @see Boot3MvcProblemDetailController#methodNotAllowedException()
     */
    @Test
     ...
     * @see Boot3MvcProblemDetailController#notAcceptableStatusException()
     */
    @Test
     ...
     * @see Boot3MvcProblemDetailController#unsupportedMediaTypeStatusException()
     */
    @Test
     ...
     * @see Boot3MvcProblemDetailController#serverErrorException()
     */
    @Test
     ...
     * @see Boot3MvcProblemDetailController#payloadTooLargeException(MultipartFile)
     */
    @Test
     ...
     * @see Boot3MvcProblemDetailController#conversionNotSupportedException(HttpServletRequest, String)
     */
    @Test
     ...
     * @see Boot3MvcProblemDetailController#methodArgumentConversionNotSupportedException(Boot3MvcProblemDetailRequest)
     */
    @Test
     ...
     * @see Boot3MvcProblemDetailController#typeMismatchException()
     */
    @Test
     ...
     * @see Boot3MvcProblemDetailController#methodArgumentTypeMismatchException(Integer)
     */
    @Test
     ...
     * @see Boot3MvcProblemDetailController#httpMessageNotReadableException(Boot3MvcProblemDetailRequest)
     */
    @Test
     ...
     * @see Boot3MvcProblemDetailController#httpMessageNotWritableException()
     * @see Boot3MvcProblemDetailResponseSerializer
     */
    @Test
     ...
     * @see Boot3MvcProblemDetailController#methodValidationException()
     * @see Boot3MvcProblemDetailService#createProblemDetail(String, Boot3MvcProblemDetailRequest)
     * @see Boot3MvcMethodValidationConfiguration#validationPostProcessor()
     */
    @Test
    ...
    class Boot3MvcNoHandlerFoundExceptionTest {
        @Test
