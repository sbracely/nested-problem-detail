...
import io.github.sbracely.extended.problem.detail.common.properties.Boot3CommonExtendedProblemDetailProperties;
 ...
 * @see Boot3CommonExtendedProblemDetailProperties
 * @since 1.0.0
 */
@ConfigurationProperties(prefix = "extended.problem-detail")
public class Boot3FluxExtendedProblemDetailProperties extends Boot3CommonExtendedProblemDetailProperties {

    /**
     * Creates a new instance with default property values.
     */
    public Boot3FluxExtendedProblemDetailProperties() {
    }
