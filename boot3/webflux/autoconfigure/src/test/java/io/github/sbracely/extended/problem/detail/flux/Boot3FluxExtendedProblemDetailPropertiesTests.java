...
/**
 * Tests for {@link Boot3FluxExtendedProblemDetailProperties}.
 *
 * @since 1.0.0
 */
class Boot3FluxExtendedProblemDetailPropertiesTests {

    private final ApplicationContextRunner contextRunner = new ApplicationContextRunner()
            .withUserConfiguration(Boot3FluxExtendedProblemDetailPropertiesConfiguration.class);
    ...
    static class Boot3FluxExtendedProblemDetailPropertiesConfiguration {
    }
}
