...
import io.github.sbracely.extended.problem.detail.webflux.example.config.Boot3FluxMethodValidationConfiguration;
import io.github.sbracely.extended.problem.detail.webflux.example.exception.Boot3FluxExtendedErrorResponseException;
...
class Boot3FluxControllerTests {

    private static final Logger logger = LoggerFactory.getLogger(Boot3FluxControllerTests.class);
     ...
     * @see Boot3FluxExtendedProblemDetailController#methodNotAllowedException()
     */
    @Test
     ...
     * @see Boot3FluxExtendedProblemDetailController#notAcceptableStatusException()
     */
    @Test
     ...
     * @see Boot3FluxExtendedProblemDetailController#unsupportedMediaTypeStatusException()
     */
    @Test
     ...
     * @see Boot3FluxExtendedProblemDetailController#missingRequestValueException(String)
     */
    @Test
     ...
     * @see Boot3FluxExtendedProblemDetailController#unsatisfiedRequestParameterException()
     */
    @Test
     ...
     * @see Boot3FluxExtendedProblemDetailController#webExchangeBindException(Boot3FluxProblemDetailRequest)
     */
    @Test
     ...
     * @see Boot3FluxExtendedProblemDetailController#handlerMethodValidationExceptionCookieValue(String)
    ...
    /**
     * @see HandlerMethodValidationException
     * @see Boot3FluxExtendedProblemDetailController#handlerMethodValidationExceptionMatrix(String, List)
    ...
    /**
     * @see HandlerMethodValidationException
     * @see Boot3FluxExtendedProblemDetailController#handlerMethodValidationExceptionModelAttribute(Boot3FluxProblemDetailRequest)
    ...
    /**
     * @see HandlerMethodValidationException
     * @see Boot3FluxExtendedProblemDetailController#handlerMethodValidationExceptionPathVariable(String)
    ...
    /**
     * @see HandlerMethodValidationException
     * @see Boot3FluxExtendedProblemDetailController#handlerMethodValidationExceptionRequestBody(Boot3FluxProblemDetailRequest)
    ...
    /**
     * @see HandlerMethodValidationException
     * @see Boot3FluxExtendedProblemDetailController#handlerMethodValidationExceptionRequestBodyValidationResult(List)
    ...
    /**
     * @see HandlerMethodValidationException
     * @see Boot3FluxExtendedProblemDetailController#handlerMethodValidationExceptionRequestHeader(String)
    ...
    /**
     * @see HandlerMethodValidationException
     * @see Boot3FluxExtendedProblemDetailController#handlerMethodValidationExceptionRequestParam(String, String)
    ...
    /**
     * @see HandlerMethodValidationException
     * @see Boot3FluxExtendedProblemDetailController#handlerMethodValidationExceptionRequestPart(FilePart)
    ...
    /**
     * @see HandlerMethodValidationException
     * @see Boot3FluxExtendedProblemDetailController#handlerMethodValidationExceptionOther(String, String, String)
...
//        );
     ...
     * @see Boot3FluxExtendedProblemDetailController#serverWebInputException()
     */
    @Test
     ...
     * @see Boot3FluxExtendedProblemDetailController#serverErrorException()
     */
    @Test
     ...
     * @see Boot3FluxExtendedProblemDetailController#responseStatusException()
     */
    @Test
     ...
     * @see Boot3FluxExtendedProblemDetailController#payloadTooLargeException(byte[])
     */
    @Test
     ...
     * @see Boot3FluxExtendedProblemDetailController#errorResponseException()
     */
    @Test
    ...
    /**
     * @see Boot3FluxExtendedErrorResponseException
     * @see Boot3FluxExtendedProblemDetailController#extendedErrorResponseException()
     */
    @Test
     ...
     * @see Boot3FluxExtendedProblemDetailController#methodValidationException()
     * @see Boot3FluxMethodValidationConfiguration#validationPostProcessor()
     */
    @Test
