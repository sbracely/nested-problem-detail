...
import io.github.sbracely.extended.problem.detail.webflux.example.service.Boot3FluxProblemDetailService;
...
public class Boot3FluxExtendedProblemDetailController {

    private static final Logger logger = LoggerFactory.getLogger(Boot3FluxExtendedProblemDetailController.class);

    private final Boot3FluxProblemDetailService problemDetailService;

    public Boot3FluxExtendedProblemDetailController(Boot3FluxProblemDetailService problemDetailService) {
    ...
    public Mono<Void> webExchangeBindException(@RequestBody @Validated Boot3FluxProblemDetailRequest problemDetailRequest) {
    ...
    public Mono<Void> handlerMethodValidationExceptionModelAttribute(@Boot3FluxCheckPassword(message = "Password cannot be empty") Boot3FluxProblemDetailRequest problemDetailRequest) {
    ...
    public Mono<Void> handlerMethodValidationExceptionRequestBody(@RequestBody @Boot3FluxCheckPassword(message = "Password cannot be empty") Boot3FluxProblemDetailRequest problemDetailRequest) {
    ...
    public Mono<Void> handlerMethodValidationExceptionRequestPart(@RequestPart(required = false)
                                                                  @Boot3FluxCheckFilePart(requiredMessage = "File cannot be empty") FilePart filePart) {
    ...
    public Mono<Void> extendedErrorResponseException() {
        ...
        throw new Boot3FluxExtendedErrorResponseException(HttpStatus.INTERNAL_SERVER_ERROR, extendedProblemDetail);
    }
    ...
    public Mono<Void> methodValidationException() {
        ...
        Boot3FluxProblemDetailRequest problemDetailRequest = new Boot3FluxProblemDetailRequest();
