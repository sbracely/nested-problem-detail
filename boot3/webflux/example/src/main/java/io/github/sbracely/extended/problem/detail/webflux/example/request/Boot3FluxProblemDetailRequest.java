...
@Boot3FluxConfirmPassword(message = "Password and confirm password do not match", fields = {"password", "confirmPassword"})
@Schema(name = "Boot3FluxProblemDetailRequest", description = "Sample request payload used by the example endpoints.")
public class Boot3FluxProblemDetailRequest {
    ...
    public String toString() {
        return "Boot3FluxProblemDetailRequest{" +
                "name='" + name + '\'' +
                ", age=" + age +
                ", password='" + password + '\'' +
