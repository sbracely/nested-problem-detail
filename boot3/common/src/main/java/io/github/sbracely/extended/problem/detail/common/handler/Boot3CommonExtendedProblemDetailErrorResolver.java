 ...
 * </p>
 * <p>
 * Implementing classes must expose their {@link Log} and {@link Boot3CommonExtendedProblemDetailLog}
 ...
 * @since 1.0.1
 */
public interface Boot3CommonExtendedProblemDetailErrorResolver {
     ...
     *
     * @return the {@link Boot3CommonExtendedProblemDetailLog} instance
     */
    Boot3CommonExtendedProblemDetailLog getExtendedProblemDetailLog();
    ...
    default List<Error> resolveHandlerMethodValidationException(HandlerMethodValidationException ex) {
        ...
        Boot3CommonExtendedProblemDetailErrorResolver self = this;
