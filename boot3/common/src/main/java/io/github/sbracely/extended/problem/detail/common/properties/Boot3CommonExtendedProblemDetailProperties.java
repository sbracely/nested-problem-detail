 ...
 * @since 1.0.0
 */
public class Boot3CommonExtendedProblemDetailProperties {
    ...
    /**
     * Boot3CommonLogging configuration for extended problem detail exception handling.
     */
    private Boot3CommonLogging logging = new Boot3CommonLogging();

    /**
     * Creates a new instance with default property values.
     */
    public Boot3CommonExtendedProblemDetailProperties() {
    }
     ...
     */
    public Boot3CommonLogging getLogging() {
        return logging;
    }
     ...
     */
    public void setLogging(Boot3CommonLogging logging) {
     ...
     * Boot3CommonLogging configuration for extended problem detail exception handling.
     */
    public static class Boot3CommonLogging {
