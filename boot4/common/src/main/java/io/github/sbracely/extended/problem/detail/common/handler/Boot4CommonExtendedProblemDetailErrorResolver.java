 ...
 * </p>
 * <p>
 * Implementing classes must expose their {@link Log} and {@link Boot4CommonExtendedProblemDetailLog}
...
public interface Boot4CommonExtendedProblemDetailErrorResolver {
     ...
     *
     * @return the {@link Boot4CommonExtendedProblemDetailLog} instance
     */
    Boot4CommonExtendedProblemDetailLog getExtendedProblemDetailLog();
    ...
    default List<Error> resolveHandlerMethodValidationException(HandlerMethodValidationException ex) {
        ...
        Boot4CommonExtendedProblemDetailErrorResolver self = this;
