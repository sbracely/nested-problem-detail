 ...
 * @since 1.0.0
 */
public class Boot4CommonExtendedProblemDetailProperties {
    ...
    /**
     * Boot4CommonLogging configuration for extended problem detail exception handling.
     */
    private Boot4CommonLogging logging = new Boot4CommonLogging();

    /**
     * Creates a new instance with default property values.
     */
    public Boot4CommonExtendedProblemDetailProperties() {
    }
     ...
     */
    public Boot4CommonLogging getLogging() {
        return logging;
    }
     ...
     */
    public void setLogging(Boot4CommonLogging logging) {
     ...
     * Boot4CommonLogging configuration for extended problem detail exception handling.
     */
    public static class Boot4CommonLogging {
