...
class Boot4MvcControllerRandomPortTests {

    private static final Logger logger = LoggerFactory.getLogger(Boot4MvcControllerRandomPortTests.class);
     ...
     * @see Boot4MvcProblemDetailController#asyncRequestNotUsableException()
     */
    @Test
    ...
    class Boot4MvcMaxUploadSizeExceededExceptionTests {
        ...
        /**
         * @see MaxUploadSizeExceededException
         * @see Boot4MvcProblemDetailController#maxUploadSizeExceededException(MultipartFile)
         */
        @Test
    ...
    @Nested
    @AutoConfigureRestTestClient
    @Import(Boot4MvcApiVersionTests.Boot4MvcNotAcceptableApiVersionController.class)
    @TestPropertySource(properties = {
            "spring.mvc.apiversion.use.header=API-Version",
            "spring.mvc.apiversion.supported=1,2",
    })
    class Boot4MvcApiVersionTests {
         ...
         * @see Boot4MvcProblemDetailController#invalidApiVersionException()
         */
        @Test
         ...
         * @see Boot4MvcNotAcceptableApiVersionController#notAcceptableApiVersion()
         */
        @Test
         ...
         * @see Boot4MvcProblemDetailController#missingApiVersionException()
         */
        @Test
         ...
         */
        @RestController
        static class Boot4MvcNotAcceptableApiVersionController {
