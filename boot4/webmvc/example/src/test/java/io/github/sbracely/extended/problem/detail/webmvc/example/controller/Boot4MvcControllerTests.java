...
import io.github.sbracely.extended.problem.detail.webmvc.example.config.Boot4MvcMethodValidationConfiguration;
import io.github.sbracely.extended.problem.detail.webmvc.example.endpoint.Boot4MvcDemoEndpoint;
import io.github.sbracely.extended.problem.detail.webmvc.example.exception.Boot4MvcExtendedErrorResponseException;
import io.github.sbracely.extended.problem.detail.webmvc.example.request.Boot4MvcProblemDetailRequest;
import io.github.sbracely.extended.problem.detail.webmvc.example.service.Boot4MvcProblemDetailService;
...
class Boot4MvcControllerTests {

    private static final Logger logger = LoggerFactory.getLogger(Boot4MvcControllerTests.class);
     ...
     * @see Boot4MvcProblemDetailController#httpRequestMethodNotSupportedException()
     */
    @Test
     ...
     * @see Boot4MvcProblemDetailController#httpMediaTypeNotSupportedException(Boot4MvcProblemDetailRequest)
     */
    @Test
     ...
     * @see Boot4MvcProblemDetailController#httpMediaTypeNotAcceptableException(Boot4MvcProblemDetailRequest)
     */
    @Test
     ...
     * @see Boot4MvcProblemDetailController#missingPathVariableException(Integer)
     */
    @Test
     ...
     * @see Boot4MvcProblemDetailController#missingServletRequestParameterException(Integer)
     */
    @Test
     ...
     * @see Boot4MvcProblemDetailController#missingServletRequestPartException(MultipartFile)
     */
    @Test
     ...
     * @see Boot4MvcProblemDetailController#servletRequestBindingException()
     */
    @Test
     ...
     * @see Boot4MvcProblemDetailController#unsatisfiedServletRequestParameterException()
     */
    @Test
     ...
     * @see Boot4MvcProblemDetailController#orgSpringWebBindMissingRequestValueException()
     */
    @Test
     ...
     * @see Boot4MvcProblemDetailController#missingMatrixVariableException(String, List)
     */
    @Test
     ...
     * @see Boot4MvcProblemDetailController#missingRequestCookieException(String)
     */
    @Test
     ...
     * @see Boot4MvcProblemDetailController#missingRequestHeaderException(String)
     */
    @Test
     ...
     * @see Boot4MvcProblemDetailController#methodArgumentNotValidException(Boot4MvcProblemDetailRequest)
     */
    @Test
     ...
     * @see Boot4MvcProblemDetailController#handlerMethodValidationExceptionCookieValue(String)
    ...
    /**
     * @see HandlerMethodValidationException
     * @see Boot4MvcProblemDetailController#handlerMethodValidationExceptionMatrixVariable(String, List)
    ...
    /**
     * @see HandlerMethodValidationException
     * @see Boot4MvcProblemDetailController#handlerMethodValidationExceptionModelAttribute(Boot4MvcProblemDetailRequest)
    ...
    /**
     * @see HandlerMethodValidationException
     * @see Boot4MvcProblemDetailController#handlerMethodValidationExceptionPathVariable(String)
    ...
    /**
     * @see HandlerMethodValidationException
     * @see Boot4MvcProblemDetailController#handlerMethodValidationExceptionRequestBody(Boot4MvcProblemDetailRequest)
    ...
    /**
     * @see HandlerMethodValidationException
     * @see Boot4MvcProblemDetailController#handlerMethodValidationExceptionRequestBodyValidationResult(List)
    ...
    /**
     * @see HandlerMethodValidationException
     * @see Boot4MvcProblemDetailController#handlerMethodValidationExceptionRequestHeader(String)
    ...
    /**
     * @see HandlerMethodValidationException
     * @see Boot4MvcProblemDetailController#handlerMethodValidationExceptionRequestParam(String, String)
    ...
    /**
     * @see HandlerMethodValidationException
     * @see Boot4MvcProblemDetailController#handlerMethodValidationExceptionRequestPart(MultipartFile)
    ...
    /**
     * @see HandlerMethodValidationException
     * @see Boot4MvcProblemDetailController#handlerMethodValidationExceptionOther(String, String, String)
     ...
     * @see Boot4MvcProblemDetailController#asyncRequestTimeoutException()
     */
    @Test
     ...
     * @see Boot4MvcProblemDetailController#errorResponseException()
     */
    @Test
    ...
    /**
     * @see Boot4MvcExtendedErrorResponseException
     * @see Boot4MvcProblemDetailController#extendedErrorResponseException()
     */
    @Test
     ...
     * @see Boot4MvcProblemDetailController#responseStatusException()
     */
    @Test
     ...
     * @see Boot4MvcProblemDetailController#serverWebInputException()
     */
    @Test
     ...
     * @see Boot4MvcProblemDetailController#unsatisfiedRequestParameterException()
     */
    @Test
     ...
     * @see Boot4MvcProblemDetailController#orgSpringframeworkWebServerMissingRequestValueException(HttpServletRequest, String)
     */
    @Test
     ...
     * @see Boot4MvcProblemDetailController#webExchangeBindException(HttpServletRequest, Boot4MvcProblemDetailRequest, BindingResult)
     */
    @Test
     ...
     * @see Boot4MvcProblemDetailController#methodNotAllowedException()
     */
    @Test
     ...
     * @see Boot4MvcProblemDetailController#notAcceptableStatusException()
     */
    @Test
     ...
     * @see Boot4MvcProblemDetailController#contentTooLargeException(MultipartFile)
     */
    @Test
     ...
     * @see Boot4MvcProblemDetailController#unsupportedMediaTypeStatusException()
     */
    @Test
     ...
     * @see Boot4MvcProblemDetailController#serverErrorException()
     */
    @Test
     ...
     * @see Boot4MvcProblemDetailController#payloadTooLargeException(MultipartFile)
     */
    @Test
     ...
     * @see Boot4MvcProblemDetailController#conversionNotSupportedException(HttpServletRequest, String)
     */
    @Test
     ...
     * @see Boot4MvcProblemDetailController#methodArgumentConversionNotSupportedException(Boot4MvcProblemDetailRequest)
     */
    @Test
     ...
     * @see Boot4MvcProblemDetailController#typeMismatchException()
     */
    @Test
     ...
     * @see Boot4MvcProblemDetailController#methodArgumentTypeMismatchException(Integer)
     */
    @Test
     ...
     * @see Boot4MvcProblemDetailController#httpMessageNotReadableException(Boot4MvcProblemDetailRequest)
     */
    @Test
     ...
     * @see Boot4MvcProblemDetailController#httpMessageNotWritableException()
     * @see Boot4MvcProblemDetailResponseSerializer
     */
    @Test
     ...
     * @see Boot4MvcProblemDetailController#methodValidationException()
     * @see Boot4MvcProblemDetailService#createProblemDetail(String, Boot4MvcProblemDetailRequest)
     * @see Boot4MvcMethodValidationConfiguration#validationPostProcessor()
     */
    @Test
    ...
    class Boot4MvcNoHandlerFoundExceptionTest {
        @Test
     ...
     * @see Boot4MvcDemoEndpoint#hello(String, String, String)
     */
    @Nested
    @TestPropertySource(properties = "management.endpoints.web.exposure.include=demo")
    class Boot4MvcInvalidEndpointBadRequestExceptionTests {
