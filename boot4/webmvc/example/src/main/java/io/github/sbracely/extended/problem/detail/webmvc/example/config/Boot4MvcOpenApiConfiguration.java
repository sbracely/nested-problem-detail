 ...
 */
@Configuration
public class Boot4MvcOpenApiConfiguration {
    ...
    OpenApiCustomizer webMvcErrorResponseCustomizer() {
        return openApi -> {
            ...
            openApi.getPaths().values().forEach(pathItem -> pathItem.readOperations().forEach(operation -> {
                ...
                Boot4MvcErrorResponseSpec errorResponseSpec = responseSpec(operation.getOperationId());
    ...
    private static Boot4MvcErrorResponseSpec responseSpec(String operationId) {
        return switch (operationId) {
            case "methodNotAllowedException" ->
                    new Boot4MvcErrorResponseSpec("405", "405 method not allowed error",
            ...
            case "httpRequestMethodNotSupportedException" ->
                    new Boot4MvcErrorResponseSpec("405", "405 method not allowed error", methodNotAllowedProblemDetailExample(),
                            "POST /mvc-extended-problem-detail/http-request-method-not-supported-exception");
            case "httpMediaTypeNotAcceptableException" ->
                    new Boot4MvcErrorResponseSpec("406", "406 not acceptable error",
            ...
            case "httpMediaTypeNotSupportedException" ->
                    new Boot4MvcErrorResponseSpec("415", "415 unsupported media type error",
            ...
            case "extendedErrorResponseException" ->
                    new Boot4MvcErrorResponseSpec("500", "500 business error", businessProblemDetailExample(),
                            "GET /mvc-extended-problem-detail/extended-error-response-exception");
            case "errorResponseException" ->
                    new Boot4MvcErrorResponseSpec("400", "400 error response exception",
            ...
            case "responseStatusException" ->
                    new Boot4MvcErrorResponseSpec("400", "400 response status error",
            ...
            case "serverWebInputException" ->
                    new Boot4MvcErrorResponseSpec("400", "400 server web input error",
            ...
            case "missingServletRequestPartException" ->
                    new Boot4MvcErrorResponseSpec("400", "400 missing request part error",
            ...
            case "servletRequestBindingException" ->
                    new Boot4MvcErrorResponseSpec("400", "400 servlet request binding error",
            ...
            case "unsatisfiedServletRequestParameterException" ->
                    new Boot4MvcErrorResponseSpec("400", "400 invalid request parameters error",
            ...
            case "missingRequestHeaderException" ->
                    new Boot4MvcErrorResponseSpec("400", "400 missing request header error",
            ...
            case "missingRequestCookieException" ->
                    new Boot4MvcErrorResponseSpec("400", "400 missing request cookie error",
            ...
            case "missingMatrixVariableException" ->
                    new Boot4MvcErrorResponseSpec("400", "400 missing matrix variable error",
            ...
            case "orgSpringWebBindMissingRequestValueException" ->
                    new Boot4MvcErrorResponseSpec("400", "400 missing request value error",
            ...
            case "orgSpringframeworkWebServerMissingRequestValueException" ->
                    new Boot4MvcErrorResponseSpec("400", "400 missing request param error",
            ...
            case "missingServletRequestParameterException" ->
                    new Boot4MvcErrorResponseSpec("400", "400 missing request parameter error",
                            genericBadRequestProblemDetailExample(),
                            "GET /mvc-extended-problem-detail/missing-servlet-request-parameter-exception");
            case "payloadTooLargeException" ->
                    new Boot4MvcErrorResponseSpec("413", "413 payload too large error",
            ...
            case "contentTooLargeException" ->
                    new Boot4MvcErrorResponseSpec("413", "413 content too large error",
            ...
            case "maxUploadSizeExceededException" ->
                    new Boot4MvcErrorResponseSpec("413", "413 max upload size exceeded error",
            ...
            case "asyncRequestTimeoutException" ->
                    new Boot4MvcErrorResponseSpec("503", "503 async timeout error",
            ...
            case "httpMessageNotWritableException" ->
                    new Boot4MvcErrorResponseSpec("500", "500 message not writable error",
            ...
            case "asyncRequestNotUsableException" ->
                    new Boot4MvcErrorResponseSpec("500", "500 async request unusable error",
            ...
            case "missingPathVariableException" ->
                    new Boot4MvcErrorResponseSpec("500", "500 missing path variable error",
            ...
            case "serverErrorException" ->
                    new Boot4MvcErrorResponseSpec("500", "500 server error", serverProblemDetailExample(),
                            "GET /mvc-extended-problem-detail/server-error-exception");
            case "conversionNotSupportedException" ->
                    new Boot4MvcErrorResponseSpec("500", "500 conversion not supported error",
                            problemExample("Conversion not supported", "Internal Server Error", 500,
                                    "Failed to convert value of type 'java.lang.String' to required type 'io.github.sbracely.extended.problem.detail.webmvc.example.request.Boot4MvcProblemDetailRequest'.",
            ...
            case "methodArgumentConversionNotSupportedException" ->
                    new Boot4MvcErrorResponseSpec("500", "500 method argument conversion not supported error",
            ...
            case "typeMismatchException" ->
                    new Boot4MvcErrorResponseSpec("400", "400 type mismatch error",
            ...
            case "methodArgumentTypeMismatchException" ->
                    new Boot4MvcErrorResponseSpec("400", "400 method argument type mismatch error",
            ...
            case "httpMessageNotReadableException" ->
                    new Boot4MvcErrorResponseSpec("400", "400 message not readable error",
            ...
            case "invalidApiVersionException" ->
                    new Boot4MvcErrorResponseSpec("400", "400 invalid API version error",
            ...
            case "missingApiVersionException" ->
                    new Boot4MvcErrorResponseSpec("400", "400 missing API version error",
            ...
            default -> new Boot4MvcErrorResponseSpec("400", "400 bad request error", genericBadRequestProblemDetailExample(),
                    "See the referenced MVC test for the exact trigger");
        };
    }

    private static Boot4MvcErrorResponseSpec validationResponseSpec(String operationId) {
        return switch (operationId) {
            case "methodArgumentNotValidException" ->
                    new Boot4MvcErrorResponseSpec("400", "400 validation error", validationProblemDetailExample(),
            ...
            case "webExchangeBindException" ->
                    new Boot4MvcErrorResponseSpec("400", "400 validation error",
            ...
            case "methodValidationException" ->
                    new Boot4MvcErrorResponseSpec("500", "500 validation error",
            ...
            default -> new Boot4MvcErrorResponseSpec("400", "400 validation error", validationProblemDetailExample(),
        ...
        return switch (operationId) {
            case "asyncRequestNotUsableException", "maxUploadSizeExceededException",
                 "invalidApiVersionException", "missingApiVersionException" ->
                    "src/test/java/io/github/sbracely/extended/problem/detail/webmvc/example/controller/Boot4MvcControllerRandomPortTests.java";
            default ->
                    "src/test/java/io/github/sbracely/extended/problem/detail/webmvc/example/controller/Boot4MvcControllerTests.java";
        };
    }
    ...
    private record Boot4MvcErrorResponseSpec(String statusCode, String description, Example example, String trigger) {
    }
}
