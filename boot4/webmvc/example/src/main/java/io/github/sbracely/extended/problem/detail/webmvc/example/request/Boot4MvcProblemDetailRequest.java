...
@Boot4MvcConfirmPassword(message = "Password and confirm password do not match", fields = {"password", "confirmPassword"})
@Schema(name = "Boot4MvcProblemDetailRequest", description = "Sample request payload used by the example endpoints.")
public class Boot4MvcProblemDetailRequest {
    ...
    public String toString() {
        return "Boot4MvcProblemDetailRequest{" +
                "name='" + name + '\'' +
                ", age=" + age +
                ", password='" + password + '\'' +
