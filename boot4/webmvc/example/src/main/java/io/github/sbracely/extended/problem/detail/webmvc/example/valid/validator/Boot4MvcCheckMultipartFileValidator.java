...
public class Boot4MvcCheckMultipartFileValidator implements ConstraintValidator<Boot4MvcCheckMultipartFile, MultipartFile> {
    ...
    @Override
    public void initialize(Boot4MvcCheckMultipartFile constraintAnnotation) {
