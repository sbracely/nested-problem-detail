...
import io.github.sbracely.extended.problem.detail.webmvc.example.valid.annotation.Boot4MvcCheckMultipartFile;
...
public class Boot4MvcProblemDetailController {

    private static final Logger logger = LoggerFactory.getLogger(Boot4MvcProblemDetailController.class);

    private final RequestMappingHandlerMapping requestMappingHandlerMapping;

    private final Boot4MvcProblemDetailService problemDetailService;

    public Boot4MvcProblemDetailController(RequestMappingHandlerMapping requestMappingHandlerMapping, Boot4MvcProblemDetailService problemDetailService) {
    ...
    public void httpMediaTypeNotSupportedException(Boot4MvcProblemDetailRequest problemDetailRequest) {
    ...
    public void httpMediaTypeNotAcceptableException(Boot4MvcProblemDetailRequest problemDetailRequest) {
    ...
    public void methodArgumentNotValidException(@RequestBody @Validated Boot4MvcProblemDetailRequest problemDetailRequest) {
    ...
    public void handlerMethodValidationExceptionModelAttribute(@Boot4MvcCheckPassword(message = "Password cannot be empty") Boot4MvcProblemDetailRequest problemDetailRequest) {
    ...
    public void handlerMethodValidationExceptionRequestBody(@RequestBody @Boot4MvcCheckPassword(message = "Password cannot be empty") Boot4MvcProblemDetailRequest problemDetailRequest) {
    ...
    public void handlerMethodValidationExceptionRequestPart(@RequestPart(required = false) @Boot4MvcCheckMultipartFile(extensionIncludeMessage = "File type not supported",
    ...
    public void extendedErrorResponseException() {
        ...
        throw new Boot4MvcExtendedErrorResponseException(HttpStatus.INTERNAL_SERVER_ERROR, extendedProblemDetail);
    }
    ...
    public void webExchangeBindException(HttpServletRequest httpServletRequest,
                                         @RequestBody @Validated Boot4MvcProblemDetailRequest problemDetailRequest,
    ...
    public void conversionNotSupportedException(HttpServletRequest httpServletRequest, String data) throws Exception {
        ...
        Boot4MvcProblemDetailRequest problemDetailRequest = simpleTypeConverter.convertIfNecessary(data, Boot4MvcProblemDetailRequest.class, methodParameters[0]);
    ...
    public void methodArgumentConversionNotSupportedException(@RequestParam Boot4MvcProblemDetailRequest error) {
    ...
    public void httpMessageNotReadableException(@RequestBody Boot4MvcProblemDetailRequest data) {
    ...
    public Boot4MvcProblemDetailResponse httpMessageNotWritableException() {
        logger.info("httpMessageNotWritableException");
        return new Boot4MvcProblemDetailResponse();
    }
    ...
    public void methodValidationException() {
        ...
        Boot4MvcProblemDetailRequest problemDetailRequest = new Boot4MvcProblemDetailRequest();
