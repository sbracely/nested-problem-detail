...
/**
 * Tests for {@link Boot4MvcExtendedProblemDetailProperties}.
 *
 * @since 1.0.0
 */
class Boot4MvcExtendedProblemDetailPropertiesTests {

    private final ApplicationContextRunner contextRunner = new ApplicationContextRunner()
            .withUserConfiguration(Boot4MvcExtendedProblemDetailPropertiesConfiguration.class);
    ...
    static class Boot4MvcExtendedProblemDetailPropertiesConfiguration {
    }
}
