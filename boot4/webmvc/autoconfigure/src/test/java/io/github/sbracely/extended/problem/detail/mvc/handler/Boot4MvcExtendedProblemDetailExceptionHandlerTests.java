...
/**
 * Tests for {@link Boot4MvcExtendedProblemDetailExceptionHandler}.
 *
 * @since 1.0.0
 */
class Boot4MvcExtendedProblemDetailExceptionHandlerTests {

    private Boot4MvcRecordingLog mockLogger;

    private Boot4MvcExtendedProblemDetailExceptionHandler handler;
    private WebRequest webRequest;

    @BeforeEach
    void setUp() {
        mockLogger = new Boot4MvcRecordingLog();
        Boot4CommonExtendedProblemDetailLog log = new Boot4CommonExtendedProblemDetailLog(LogLevel.DEBUG, false);
        handler = new Boot4MvcExtendedProblemDetailExceptionHandler(log);
    ...
    @Nested
    class Boot4MvcHandleMethodArgumentNotValid {

        @Test
        void shouldReturnExtendedProblemDetailWithFieldErrors() {
            BindingResult bindingResult = new BeanPropertyBindingResult(new Boot4MvcTestBean(), "testBean");
        ...
        void shouldLogHandleMethodArgumentNotValid() {
            Boot4MvcExtendedProblemDetailExceptionHandlerWithMockLogger h = handlerWithMockLogger(LogLevel.DEBUG, false);
            BindingResult bindingResult = new BeanPropertyBindingResult(new Boot4MvcTestBean(), "testBean");
    ...
    @Nested
    class Boot4MvcHandleHandlerMethodValidationException {
    ...
    @Nested
    class Boot4MvcHandleMethodValidationException {
    ...
    @Nested
    class Boot4MvcHandleErrorResponseException {
    ...
    @Nested
    class Boot4MvcHandleAsyncRequestNotUsableException {
    ...
    @Nested
    class Boot4MvcResolveMethodArgumentNotValidException {
    ...
    @Nested
    class Boot4MvcResolveWebExchangeBindException {
    ...
    @Nested
    class Boot4MvcResolveBindingResult {
    ...
    @Nested
    class Boot4MvcObjectErrorToError {
    ...
    @Nested
    class Boot4MvcAddParameterErrors {
    ...
    @Nested
    class Boot4MvcResolveMethodValidationException {
    ...
    @Nested
    class Boot4MvcResolveHandlerMethodValidationExceptionVisitors {
    ...
    @Nested
    class Boot4MvcDelegateToSuperHandlers {
    ...
    @Nested
    class Boot4MvcLogBehavior {

        @Test
        void shouldLogWithExceptionWhenPrintStackTraceEnabled() {
            Boot4MvcExtendedProblemDetailExceptionHandlerWithMockLogger h = handlerWithMockLogger(LogLevel.DEBUG, true);
            BindingResult bindingResult = new BeanPropertyBindingResult(new Boot4MvcTestBean(), "testBean");
            bindingResult.addError(new FieldError("testBean", "f", "error"));
            MethodArgumentNotValidException ex = new MethodArgumentNotValidException(createMethodParameter(), bindingResult);
        ...
        void shouldNotLogWhenLevelIsOff() {
            Boot4MvcExtendedProblemDetailExceptionHandlerWithMockLogger h = handlerWithMockLogger(LogLevel.OFF, false);
            BindingResult bindingResult = new BeanPropertyBindingResult(new Boot4MvcTestBean(), "testBean");
            bindingResult.addError(new FieldError("testBean", "f", "error"));
            MethodArgumentNotValidException ex = new MethodArgumentNotValidException(createMethodParameter(), bindingResult);
        ...
        void shouldLogAtInfoLevel() {
            Boot4MvcExtendedProblemDetailExceptionHandlerWithMockLogger h = handlerWithMockLogger(LogLevel.INFO, false);
            BindingResult bindingResult = new BeanPropertyBindingResult(new Boot4MvcTestBean(), "testBean");
            bindingResult.addError(new FieldError("testBean", "f", "error"));
            MethodArgumentNotValidException ex = new MethodArgumentNotValidException(createMethodParameter(), bindingResult);
        ...
        void shouldLogAtWarnLevel() {
            Boot4MvcExtendedProblemDetailExceptionHandlerWithMockLogger h = handlerWithMockLogger(LogLevel.WARN, false);
            BindingResult bindingResult = new BeanPropertyBindingResult(new Boot4MvcTestBean(), "testBean");
            bindingResult.addError(new FieldError("testBean", "f", "error"));
            MethodArgumentNotValidException ex = new MethodArgumentNotValidException(createMethodParameter(), bindingResult);
        ...
        void shouldLogAtErrorLevel() {
            Boot4MvcExtendedProblemDetailExceptionHandlerWithMockLogger h = handlerWithMockLogger(LogLevel.ERROR, false);
            BindingResult bindingResult = new BeanPropertyBindingResult(new Boot4MvcTestBean(), "testBean");
            bindingResult.addError(new FieldError("testBean", "f", "error"));
            MethodArgumentNotValidException ex = new MethodArgumentNotValidException(createMethodParameter(), bindingResult);
    ...
    private Boot4MvcExtendedProblemDetailExceptionHandlerWithMockLogger handlerWithMockLogger(
            LogLevel level, boolean printStackTrace) {
        return new Boot4MvcExtendedProblemDetailExceptionHandlerWithMockLogger(
                new Boot4CommonExtendedProblemDetailLog(level, printStackTrace), mockLogger);
    }

    private MethodParameter createMethodParameter() {
        try {
            Method method = getClass().getMethod("testMethod", Boot4MvcTestBean.class);
    ...
    public void testMethod(Boot4MvcTestBean bean) {
    ...
    private ParameterErrors buildParameterErrors(List<ObjectError> objectErrors) {
        BeanPropertyBindingResult bindingResult = new BeanPropertyBindingResult(new Boot4MvcTestBean(), "testBean");
    ...
    private HandlerMethodValidationException buildExceptionVisiting(
        ...
        MethodValidationResult mvr = MethodValidationResult.create(
                new Boot4MvcTestBean(), getTestMethod(), List.of(placeholder));
    ...
    private static Boot4MvcLogVerifier verify(Boot4MvcRecordingLog log) {
        return new Boot4MvcLogVerifier(log);
    }

    private static Boot4MvcMessageExpectation eq(String expected) {
        return actual -> actual.equals(expected);
    }

    private static Boot4MvcThrowableExpectation eq(Throwable expected) {
        return actual -> actual == expected;
    }

    private static Boot4MvcMessageExpectation matches(String regex) {
        return actual -> actual.matches(regex);
    }

    private static Boot4MvcThrowableExpectation isNull() {
        return actual -> actual == null;
    }

    private static void verifyNoInteractions(Boot4MvcRecordingLog log) {
        assertThat(log.events()).isEmpty();
    }

    private Method getTestMethod() {
        try {
            return getClass().getMethod("testMethod", Boot4MvcTestBean.class);
        } catch (NoSuchMethodException e) {
            throw new RuntimeException(e);
        }
    }
    ...
    static class Boot4MvcExtendedProblemDetailExceptionHandlerWithMockLogger
            extends Boot4MvcExtendedProblemDetailExceptionHandler {

        Boot4MvcExtendedProblemDetailExceptionHandlerWithMockLogger(
        ...
        private void injectLogger(Log mockLog) {
            try {
                java.lang.reflect.Field f =
                        Boot4MvcExtendedProblemDetailExceptionHandler.class.getDeclaredField("logger");
    ...
    @FunctionalInterface
    interface Boot4MvcMessageExpectation {
        boolean matches(String actual);
    }

    @FunctionalInterface
    interface Boot4MvcThrowableExpectation {
        boolean matches(Throwable actual);
    }

    record Boot4MvcLogEvent(String level, String message, Throwable throwable) {
    }

    static final class Boot4MvcLogVerifier {

        private final Boot4MvcRecordingLog log;

        Boot4MvcLogVerifier(Boot4MvcRecordingLog log) {
            this.log = log;
        }
        ...
        void debug(Boot4MvcMessageExpectation message, Boot4MvcThrowableExpectation throwable) {
        ...
        void info(Boot4MvcMessageExpectation message, Boot4MvcThrowableExpectation throwable) {
        ...
        void warn(Boot4MvcMessageExpectation message, Boot4MvcThrowableExpectation throwable) {
        ...
        void error(Boot4MvcMessageExpectation message, Boot4MvcThrowableExpectation throwable) {
            assertLogged("error", message::matches, throwable::matches);
        }

        private void assertLogged(String level, Boot4MvcMessageExpectation message, Boot4MvcThrowableExpectation throwable) {
    ...
    static final class Boot4MvcRecordingLog implements Log {

        private final List<Boot4MvcLogEvent> events = new ArrayList<>();

        List<Boot4MvcLogEvent> events() {
            return events;
        }

        private void add(String level, Object message, Throwable throwable) {
            events.add(new Boot4MvcLogEvent(level, String.valueOf(message), throwable));
        }
    ...
    public static class Boot4MvcTestBean {
