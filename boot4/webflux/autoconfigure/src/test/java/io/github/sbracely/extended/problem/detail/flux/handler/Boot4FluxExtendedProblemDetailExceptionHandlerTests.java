...
/**
 * Tests for {@link Boot4FluxExtendedProblemDetailExceptionHandler}.
 *
 * @since 1.0.0
 */
class Boot4FluxExtendedProblemDetailExceptionHandlerTests {

    private Boot4FluxRecordingLog mockLogger;

    private Boot4FluxExtendedProblemDetailExceptionHandler handler;
    private ServerWebExchange exchange;

    @BeforeEach
    void setUp() {
        mockLogger = new Boot4FluxRecordingLog();
        Boot4CommonExtendedProblemDetailLog log = new Boot4CommonExtendedProblemDetailLog(LogLevel.DEBUG, false);
        handler = new Boot4FluxExtendedProblemDetailExceptionHandler(log);
    ...
    @Nested
    class Boot4FluxHandleWebExchangeBindException {

        @Test
        void shouldReturnExtendedProblemDetailWithFieldErrors() {
            BindingResult bindingResult = new BeanPropertyBindingResult(new Boot4FluxTestBean(), "testBean");
        ...
        void shouldLogHandleWebExchangeBindException() {
            Boot4FluxExtendedProblemDetailExceptionHandlerWithMockLogger h = handlerWithMockLogger(LogLevel.DEBUG, false);
            BindingResult bindingResult = new BeanPropertyBindingResult(new Boot4FluxTestBean(), "testBean");
    ...
    @Nested
    class Boot4FluxHandleHandlerMethodValidationException {
    ...
    @Nested
    class Boot4FluxHandleMethodValidationException {
    ...
    @Nested
    class Boot4FluxResolveMethodValidationException {
    ...
    @Nested
    class Boot4FluxResolveWebExchangeBindException {
    ...
    @Nested
    class Boot4FluxResolveBindingResult {
    ...
    @Nested
    class Boot4FluxObjectErrorToError {
    ...
    @Nested
    class Boot4FluxAddParameterErrors {
    ...
    @Nested
    class Boot4FluxResolveHandlerMethodValidationExceptionVisitors {
    ...
    @Nested
    class Boot4FluxDelegateToSuperHandlers {
    ...
    @Nested
    class Boot4FluxLogBehavior {

        @Test
        void shouldLogWithExceptionWhenPrintStackTraceEnabled() {
            Boot4FluxExtendedProblemDetailExceptionHandlerWithMockLogger h = handlerWithMockLogger(LogLevel.DEBUG, true);
            BindingResult bindingResult = new BeanPropertyBindingResult(new Boot4FluxTestBean(), "testBean");
        ...
        void shouldNotLogWhenLevelIsOff() {
            Boot4FluxExtendedProblemDetailExceptionHandlerWithMockLogger h = handlerWithMockLogger(LogLevel.OFF, false);
            BindingResult bindingResult = new BeanPropertyBindingResult(new Boot4FluxTestBean(), "testBean");
            bindingResult.addError(new FieldError("testBean", "field", "error"));
            WebExchangeBindException ex = new WebExchangeBindException(createMethodParameter(), bindingResult);
        ...
        void shouldLogAtInfoLevel() {
            Boot4FluxExtendedProblemDetailExceptionHandlerWithMockLogger h = handlerWithMockLogger(LogLevel.INFO, false);
            BindingResult bindingResult = new BeanPropertyBindingResult(new Boot4FluxTestBean(), "testBean");
            bindingResult.addError(new FieldError("testBean", "field", "error"));
            WebExchangeBindException ex = new WebExchangeBindException(createMethodParameter(), bindingResult);
        ...
        void shouldLogAtWarnLevel() {
            Boot4FluxExtendedProblemDetailExceptionHandlerWithMockLogger h = handlerWithMockLogger(LogLevel.WARN, false);
            BindingResult bindingResult = new BeanPropertyBindingResult(new Boot4FluxTestBean(), "testBean");
            bindingResult.addError(new FieldError("testBean", "field", "error"));
            WebExchangeBindException ex = new WebExchangeBindException(createMethodParameter(), bindingResult);
        ...
        void shouldLogAtErrorLevel() {
            Boot4FluxExtendedProblemDetailExceptionHandlerWithMockLogger h = handlerWithMockLogger(LogLevel.ERROR, false);
            BindingResult bindingResult = new BeanPropertyBindingResult(new Boot4FluxTestBean(), "testBean");
            bindingResult.addError(new FieldError("testBean", "field", "error"));
            WebExchangeBindException ex = new WebExchangeBindException(createMethodParameter(), bindingResult);
    ...
    private Boot4FluxExtendedProblemDetailExceptionHandlerWithMockLogger handlerWithMockLogger(
            LogLevel level, boolean printStackTrace) {
        return new Boot4FluxExtendedProblemDetailExceptionHandlerWithMockLogger(
                new Boot4CommonExtendedProblemDetailLog(level, printStackTrace), mockLogger);
    }
    ...
    private MethodParameter createMethodParameter() {
        try {
            Method method = getClass().getMethod("testMethod", Boot4FluxTestBean.class);
    ...
    public void testMethod(Boot4FluxTestBean bean) {
    ...
    private ParameterErrors buildParameterErrors(List<ObjectError> objectErrors) {
        BeanPropertyBindingResult bindingResult = new BeanPropertyBindingResult(new Boot4FluxTestBean(), "testBean");
    ...
    private HandlerMethodValidationException buildExceptionVisiting(
        ...
        MethodValidationResult mvr = MethodValidationResult.create(
                new Boot4FluxTestBean(), getTestMethod(), List.of(placeholder));
    ...
    private static Boot4FluxLogVerifier verify(Boot4FluxRecordingLog log) {
        return new Boot4FluxLogVerifier(log);
    }

    private static Boot4FluxMessageExpectation eq(String expected) {
        return actual -> actual.equals(expected);
    }

    private static Boot4FluxThrowableExpectation eq(Throwable expected) {
        return actual -> actual == expected;
    }

    private static Boot4FluxMessageExpectation matches(String regex) {
        return actual -> actual.matches(regex);
    }

    private static Boot4FluxThrowableExpectation isNull() {
        return actual -> actual == null;
    }

    private static void verifyNoInteractions(Boot4FluxRecordingLog log) {
        assertThat(log.events()).isEmpty();
    }

    private Method getTestMethod() {
        try {
            return getClass().getMethod("testMethod", Boot4FluxTestBean.class);
        } catch (NoSuchMethodException e) {
            throw new RuntimeException(e);
        }
    }
     ...
     */
    static class Boot4FluxExtendedProblemDetailExceptionHandlerWithMockLogger
            extends Boot4FluxExtendedProblemDetailExceptionHandler {

        Boot4FluxExtendedProblemDetailExceptionHandlerWithMockLogger(
                Boot4CommonExtendedProblemDetailLog extendedProblemDetailLog, Log mockLog) {
            super(extendedProblemDetailLog);
            injectLogger(mockLog);
        }

        private void injectLogger(Log mockLog) {
            // The logger field is declared in Boot4FluxExtendedProblemDetailExceptionHandler
            try {
                java.lang.reflect.Field f =
                        Boot4FluxExtendedProblemDetailExceptionHandler.class.getDeclaredField("logger");
    ...
    @FunctionalInterface
    interface Boot4FluxMessageExpectation {
        boolean matches(String actual);
    }

    @FunctionalInterface
    interface Boot4FluxThrowableExpectation {
        boolean matches(Throwable actual);
    }

    record Boot4FluxLogEvent(String level, String message, Throwable throwable) {
    }

    static final class Boot4FluxLogVerifier {

        private final Boot4FluxRecordingLog log;

        Boot4FluxLogVerifier(Boot4FluxRecordingLog log) {
            this.log = log;
        }
        ...
        void debug(Boot4FluxMessageExpectation message, Boot4FluxThrowableExpectation throwable) {
        ...
        void info(Boot4FluxMessageExpectation message, Boot4FluxThrowableExpectation throwable) {
        ...
        void warn(Boot4FluxMessageExpectation message, Boot4FluxThrowableExpectation throwable) {
        ...
        void error(Boot4FluxMessageExpectation message, Boot4FluxThrowableExpectation throwable) {
            assertLogged("error", message::matches, throwable::matches);
        }

        private void assertLogged(String level, Boot4FluxMessageExpectation message, Boot4FluxThrowableExpectation throwable) {
    ...
    static final class Boot4FluxRecordingLog implements Log {

        private final List<Boot4FluxLogEvent> events = new ArrayList<>();

        List<Boot4FluxLogEvent> events() {
            return events;
        }

        private void add(String level, Object message, Throwable throwable) {
            events.add(new Boot4FluxLogEvent(level, String.valueOf(message), throwable));
        }
    ...
    public static class Boot4FluxTestBean {
