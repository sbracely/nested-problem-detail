...
import io.github.sbracely.extended.problem.detail.common.properties.Boot4CommonExtendedProblemDetailProperties;
 ...
 * @see Boot4CommonExtendedProblemDetailProperties
 * @since 1.0.0
 */
@ConfigurationProperties(prefix = "extended.problem-detail")
public class Boot4FluxExtendedProblemDetailProperties extends Boot4CommonExtendedProblemDetailProperties {

    /**
     * Creates a new instance with default property values.
     */
    public Boot4FluxExtendedProblemDetailProperties() {
    }
