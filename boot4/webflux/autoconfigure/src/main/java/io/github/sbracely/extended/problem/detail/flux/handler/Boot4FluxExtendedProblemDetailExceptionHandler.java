...
import io.github.sbracely.extended.problem.detail.common.handler.Boot4CommonExtendedProblemDetailErrorResolver;
 ...
 * the corresponding resolveXxx methods defined in {@link Boot4CommonExtendedProblemDetailErrorResolver}.
 * </p>
 *
 * @see ResponseEntityExceptionHandler
 * @see Boot4CommonExtendedProblemDetailErrorResolver
 * @since 1.0.0
 */
@RestControllerAdvice
public class Boot4FluxExtendedProblemDetailExceptionHandler extends ResponseEntityExceptionHandler
        implements Boot4CommonExtendedProblemDetailErrorResolver {
     ...
     */
    protected final Boot4CommonExtendedProblemDetailLog extendedProblemDetailLog;
     ...
     */
    public Boot4FluxExtendedProblemDetailExceptionHandler(Boot4CommonExtendedProblemDetailLog extendedProblemDetailLog) {
    ...
    @Override
    public Boot4CommonExtendedProblemDetailLog getExtendedProblemDetailLog() {
