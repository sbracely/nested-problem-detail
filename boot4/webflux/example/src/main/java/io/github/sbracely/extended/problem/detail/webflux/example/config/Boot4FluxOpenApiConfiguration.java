...
@Configuration
public class Boot4FluxOpenApiConfiguration {
    ...
    OpenApiCustomizer webFluxErrorResponseCustomizer() {
        return openApi -> {
            ...
            openApi.getPaths().values().forEach(pathItem -> pathItem.readOperations().forEach(operation -> {
                ...
                Boot4FluxErrorResponseSpec errorResponseSpec = responseSpec(operation.getOperationId());
                ...
                operation.setDescription(testGuidance(errorResponseSpec.trigger(),
                        "src/test/java/io/github/sbracely/extended/problem/detail/webflux/example/controller/Boot4FluxControllerTests.java"));
            }));
        };
    }
    ...
    private static Boot4FluxErrorResponseSpec responseSpec(String operationId) {
        return switch (operationId) {
            case "methodNotAllowedException" ->
                    new Boot4FluxErrorResponseSpec("405", "405 method not allowed error", methodNotAllowedProblemDetailExample(),
                            "DELETE /flux-extended-problem-detail/method-not-allowed-exception");
            case "notAcceptableStatusException" ->
                    new Boot4FluxErrorResponseSpec("406", "406 not acceptable error", notAcceptableProblemDetailExample(),
                            "GET /flux-extended-problem-detail/not-acceptable-status-exception");
            case "unsupportedMediaTypeStatusException" ->
                    new Boot4FluxErrorResponseSpec("415", "415 unsupported media type error", unsupportedMediaTypeProblemDetailExample(),
            ...
            case "extendedErrorResponseException" ->
                    new Boot4FluxErrorResponseSpec("500", "500 business error", businessProblemDetailExample(),
                            "GET /flux-extended-problem-detail/extended-error-response-exception");
            case "errorResponseException" ->
                    new Boot4FluxErrorResponseSpec("400", "400 error response exception",
            ...
            case "responseStatusException" ->
                    new Boot4FluxErrorResponseSpec("400", "400 response status error",
            ...
            case "missingRequestValueException" ->
                    new Boot4FluxErrorResponseSpec("400", "400 missing request value error", genericBadRequestProblemDetailExample(),
                            "GET /flux-extended-problem-detail/missing-request-value-exception without id");
            case "unsatisfiedRequestParameterException" ->
                    new Boot4FluxErrorResponseSpec("400", "400 invalid request parameters error",
            ...
            case "contentTooLargeException" ->
                    new Boot4FluxErrorResponseSpec("413", "413 content too large error",
            ...
            case "serverWebInputException" ->
                    new Boot4FluxErrorResponseSpec("400", "400 server web input error",
            ...
            case "serverErrorException" ->
                    new Boot4FluxErrorResponseSpec("500", "500 server error", serverProblemDetailExample(),
                            "GET /flux-extended-problem-detail/server-error-exception");
            case "invalidApiVersionException" ->
                    new Boot4FluxErrorResponseSpec("400", "400 invalid API version error",
            ...
            case "missingApiVersionException" ->
                    new Boot4FluxErrorResponseSpec("400", "400 missing API version error",
            ...
            default -> new Boot4FluxErrorResponseSpec("400", "400 bad request error", genericBadRequestProblemDetailExample(),
                    "See the referenced WebFlux test for the exact trigger");
        };
    }

    private static Boot4FluxErrorResponseSpec validationResponseSpec(String operationId) {
        return switch (operationId) {
            case "webExchangeBindException" ->
                    new Boot4FluxErrorResponseSpec("400", "400 validation error", validationProblemDetailExample(),
            ...
            case "handlerMethodValidationExceptionCookieValue" ->
                    new Boot4FluxErrorResponseSpec("400", "400 validation error",
            ...
            case "methodValidationException" ->
                    new Boot4FluxErrorResponseSpec("500", "500 validation error",
    ...
    private record Boot4FluxErrorResponseSpec(String statusCode, String description, Example example, String trigger) {
    }
}
