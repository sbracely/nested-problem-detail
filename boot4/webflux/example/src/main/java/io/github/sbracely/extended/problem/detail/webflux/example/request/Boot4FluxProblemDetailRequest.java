...
@Boot4FluxConfirmPassword(message = "Password and confirm password do not match", fields = {"password", "confirmPassword"})
@Schema(name = "Boot4FluxProblemDetailRequest", description = "Sample request payload used by the example endpoints.")
public class Boot4FluxProblemDetailRequest {
    ...
    public String toString() {
        return "Boot4FluxProblemDetailRequest{" +
                "name='" + name + '\'' +
                ", age=" + age +
                ", password='" + password + '\'' +
