...
public class Boot4FluxCheckNameValidator implements ConstraintValidator<Boot4FluxCheckName, Object[]> {
    private int nameIndex;
    private int problemDetailRequestIndex;

    @Override
    public void initialize(Boot4FluxCheckName constraintAnnotation) {
    ...
    public boolean isValid(Object[] value, ConstraintValidatorContext context) {
        ...
        String problemDetailRequestName = Optional.ofNullable(value[problemDetailRequestIndex])
                .map(obj -> ((Boot4FluxProblemDetailRequest) obj))
                .map(Boot4FluxProblemDetailRequest::getName)
                .orElse(null);
