...
public class Boot4FluxCheckFilePartValidator implements ConstraintValidator<Boot4FluxCheckFilePart, FilePart> {
    ...
    @Override
    public void initialize(Boot4FluxCheckFilePart constraintAnnotation) {
