...
import io.github.sbracely.extended.problem.detail.webflux.example.service.Boot4FluxProblemDetailService;
import io.github.sbracely.extended.problem.detail.webflux.example.valid.annotation.Boot4FluxCheckFilePart;
...
public class Boot4FluxExtendedProblemDetailController {

    private static final Logger logger = LoggerFactory.getLogger(Boot4FluxExtendedProblemDetailController.class);

    private final Boot4FluxProblemDetailService problemDetailService;

    public Boot4FluxExtendedProblemDetailController(Boot4FluxProblemDetailService problemDetailService) {
    ...
    public Mono<Void> webExchangeBindException(@RequestBody @Validated Boot4FluxProblemDetailRequest problemDetailRequest) {
    ...
    public Mono<Void> handlerMethodValidationExceptionModelAttribute(@Boot4FluxCheckPassword(message = "Password cannot be empty") Boot4FluxProblemDetailRequest problemDetailRequest) {
    ...
    public Mono<Void> handlerMethodValidationExceptionRequestBody(@RequestBody @Boot4FluxCheckPassword(message = "Password cannot be empty") Boot4FluxProblemDetailRequest problemDetailRequest) {
    ...
    public Mono<Void> handlerMethodValidationExceptionRequestPart(@RequestPart(required = false)
                                                                  @Boot4FluxCheckFilePart(requiredMessage = "File cannot be empty") FilePart filePart) {
    ...
    public Mono<Void> extendedErrorResponseException() {
        ...
        throw new Boot4FluxExtendedErrorResponseException(HttpStatus.INTERNAL_SERVER_ERROR, extendedProblemDetail);
    }
    ...
    public Mono<Void> methodValidationException() {
        ...
        Boot4FluxProblemDetailRequest problemDetailRequest = new Boot4FluxProblemDetailRequest();
