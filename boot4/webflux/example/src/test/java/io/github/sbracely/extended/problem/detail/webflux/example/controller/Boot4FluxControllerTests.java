...
import io.github.sbracely.extended.problem.detail.webflux.example.config.Boot4FluxMethodValidationConfiguration;
import io.github.sbracely.extended.problem.detail.webflux.example.exception.Boot4FluxExtendedErrorResponseException;
...
class Boot4FluxControllerTests {

    private static final Logger logger = LoggerFactory.getLogger(Boot4FluxControllerTests.class);
     ...
     * @see Boot4FluxExtendedProblemDetailController#methodNotAllowedException()
     */
    @Test
     ...
     * @see Boot4FluxExtendedProblemDetailController#notAcceptableStatusException()
     */
    @Test
     ...
     * @see Boot4FluxExtendedProblemDetailController#unsupportedMediaTypeStatusException()
     */
    @Test
     ...
     * @see Boot4FluxExtendedProblemDetailController#missingRequestValueException(String)
     */
    @Test
     ...
     * @see Boot4FluxExtendedProblemDetailController#unsatisfiedRequestParameterException()
     */
    @Test
     ...
     * @see Boot4FluxExtendedProblemDetailController#webExchangeBindException(Boot4FluxProblemDetailRequest)
     */
    @Test
     ...
     * @see Boot4FluxExtendedProblemDetailController#handlerMethodValidationExceptionCookieValue(String)
    ...
    /**
     * @see HandlerMethodValidationException
     * @see Boot4FluxExtendedProblemDetailController#handlerMethodValidationExceptionMatrix(String, List)
    ...
    /**
     * @see HandlerMethodValidationException
     * @see Boot4FluxExtendedProblemDetailController#handlerMethodValidationExceptionModelAttribute(Boot4FluxProblemDetailRequest)
    ...
    /**
     * @see HandlerMethodValidationException
     * @see Boot4FluxExtendedProblemDetailController#handlerMethodValidationExceptionPathVariable(String)
    ...
    /**
     * @see HandlerMethodValidationException
     * @see Boot4FluxExtendedProblemDetailController#handlerMethodValidationExceptionRequestBody(Boot4FluxProblemDetailRequest)
    ...
    /**
     * @see HandlerMethodValidationException
     * @see Boot4FluxExtendedProblemDetailController#handlerMethodValidationExceptionRequestBodyValidationResult(List)
    ...
    /**
     * @see HandlerMethodValidationException
     * @see Boot4FluxExtendedProblemDetailController#handlerMethodValidationExceptionRequestHeader(String)
    ...
    /**
     * @see HandlerMethodValidationException
     * @see Boot4FluxExtendedProblemDetailController#handlerMethodValidationExceptionRequestParam(String, String)
    ...
    /**
     * @see HandlerMethodValidationException
     * @see Boot4FluxExtendedProblemDetailController#handlerMethodValidationExceptionRequestPart(FilePart)
    ...
    /**
     * @see HandlerMethodValidationException
     * @see Boot4FluxExtendedProblemDetailController#handlerMethodValidationExceptionOther(String, String, String)
...
//        );
     ...
     * @see Boot4FluxExtendedProblemDetailController#serverWebInputException()
     */
    @Test
     ...
     * @see Boot4FluxExtendedProblemDetailController#serverErrorException()
     */
    @Test
     ...
     * @see Boot4FluxExtendedProblemDetailController#responseStatusException()
     */
    @Test
     ...
     * @see Boot4FluxExtendedProblemDetailController#contentTooLargeException(byte[])
     */
    @Test
     ...
     * @see Boot4FluxExtendedProblemDetailController#payloadTooLargeException(byte[])
     */
    @Test
     ...
     * @see Boot4FluxExtendedProblemDetailController#errorResponseException()
     */
    @Test
    ...
    /**
     * @see Boot4FluxExtendedErrorResponseException
     * @see Boot4FluxExtendedProblemDetailController#extendedErrorResponseException()
     */
    @Test
     ...
     * @see Boot4FluxExtendedProblemDetailController#methodValidationException()
     * @see Boot4FluxMethodValidationConfiguration#validationPostProcessor()
     */
    @Test
    ...
    @AutoConfigureWebTestClient(timeout = "PT1M")
    @Import(Boot4FluxApiVersionTests.Boot4FluxNotAcceptableApiVersionController.class)
    class Boot4FluxApiVersionTests {

        /**
         * @see InvalidApiVersionException
         * @see Boot4FluxExtendedProblemDetailController#invalidApiVersionException()
         */
        @Test
         ...
         * @see Boot4FluxExtendedProblemDetailController#missingApiVersionException()
         */
        @Test
         ...
         * @see Boot4FluxNotAcceptableApiVersionController#notAcceptableApiVersion()
         */
        @Test
         ...
         */
        @RestController
        static class Boot4FluxNotAcceptableApiVersionController {
