...
public class FluxCheckFilePartValidator implements ConstraintValidator<FluxCheckFilePart, FilePart> {
    ...
    @Override
    public void initialize(FluxCheckFilePart constraintAnnotation) {
