...
public class MvcCheckMultipartFileValidator implements ConstraintValidator<MvcCheckMultipartFile, MultipartFile> {
    ...
    @Override
    public void initialize(MvcCheckMultipartFile constraintAnnotation) {
