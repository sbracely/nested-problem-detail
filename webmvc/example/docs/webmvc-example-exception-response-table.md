...
... (the stream keeps sending data; `AsyncRequestNotUsableException` is only triggered after the client times out/disconnects and the server writes again)</pre></td>
    </tr>
  </tbody>
</table>
